 ...
 */
fun randomArray(n:Int):Array<Double> = TODO()

/**
 * Generate an array of negative numbers in decreasing order
 * @param n the size of the array
 */
fun negativeArrayDecreasing(n: Int): Array<Double> = TODO()

/**
 * Generate an array of positive numbers in increasing order
 * @param n the size of the array
 */
fun positiveArrayIncreasing(n: Int): Array<Double> = TODO()
 ...
 */
fun getMultiples(n: Int, initial: Int): Array<Int> = TODO()
